import { traverseObject, validatePath } from '../ObjectTraversalUtils';
...
describe('test validatePath', () => {
	...
	test('should throw on empty path part', () => {
		expect(() => validatePath('.')).toThrow(OPDUtilsObjectTraversalError);

		expect(() => validatePath('..')).toThrow(OPDUtilsObjectTraversalError);

		expect(() => validatePath('a..b')).toThrow(OPDUtilsObjectTraversalError);

		expect(() => validatePath('a.')).toThrow(OPDUtilsObjectTraversalError);
